...
// --- M4 ------------------------------------------------------------------
inline int module = 4;
inline std::vector<int> module_channels = {1, 3};
inline std::vector<double> v_brs     = {27.42, 27.34};
inline std::vector<double> err_v_brs = {0.16, 0.17};
...
inline std::vector<std::vector<int>> run_batches = {{34130, 34131, 34132, 34133, 34134, 34135, 34136, 34137, 34138, 34139,
